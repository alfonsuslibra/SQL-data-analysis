...
trns_type varchar(20) check (trans_type in ("wire transfer", "card transaction", "net banking")), 
trns_date date, 
...
insert into employee (emp_id, first_name, last_name, salary, branch_code) values ('E1', 'Jelene', 'Diggin', 39000, 'BR1');
insert into employee (emp_id, first_name, last_name, salary, branch_code) values ('E2', 'Nettle', 'Crofts', 66000, 'BR1');
insert into employee (emp_id, first_name, last_name, salary, branch_code) values ('E3', 'Bobbie', 'Fenby', 65000, 'BR1');
insert into employee (emp_id, first_name, last_name, salary, branch_code) values ('E4', 'Magdalene', 'Ashelford', 88000, 'BR1');
insert into employee (emp_id, first_name, last_name, salary, branch_code) values ('E5', 'Raleigh', 'McGiffie', 91000, 'BR1');
insert into employee (emp_id, first_name, last_name, salary, branch_code) values ('E6', 'Corina', 'McNuff', 30000, 'BR1');
insert into employee (emp_id, first_name, last_name, salary, branch_code) values ('E7', 'Carlotta', 'McWard', 26000, 'BR2');
insert into employee (emp_id, first_name, last_name, salary, branch_code) values ('E8', 'Kiah', 'Devoy', 70000, 'BR2');
insert into employee (emp_id, first_name, last_name, salary, branch_code) values ('E9', 'Theodor', 'Yegorov', 83000, 'BR1');
insert into employee (emp_id, first_name, last_name, salary, branch_code) values ('E10', 'Meredith', 'Raincin', 92000, 'BR1');
